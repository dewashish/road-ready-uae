      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
        ...
        <NeoCard level={2} shadow={passed ? 'secondary' : 'default'} className="text-center mb-6">
          ...
          <p className="mt-3 text-sm text-on-surface-variant">
            {passed
              ? dict.mockExam.passMessageExam
              : dict.mockExam.failMessageExam.replace('{percent}', String(MOCK_EXAM_PASS_PERCENT))}
          </p>
        </NeoCard>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          ...
          <NeoCard level={1} shadow="none" className="text-center !p-4">
            ...
            <p className="font-label text-[10px] text-on-surface-variant uppercase tracking-wider">{dict.mockExam.timeSpent}</p>
          </NeoCard>
        </div>
        ...
        <div className="space-y-3">
          <Link href={localePath(locale, `/quiz/${vehicleType}/mock-exam/${examId}`)}>
